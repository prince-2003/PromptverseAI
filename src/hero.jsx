...
function Hero() {
  ...
  useEffect(() => {
    ...
    const handleAnimation = () => {
      ...
      gsap.to(moon, {
        y: travelDistance-window.innerHeight, 
        duration: 3, 
        ease: "power1.inOut", 
      });
    };
  ...
  return (
    <div className="h-[90vh] md:h-[100vh] relative w-full text-center flex flex-col justify-center items-center">
  ...
  <svg 
  ref={moonRef}
  className="absolute -bottom-0 -z-10 w-[500px] h-[500px] md:w-[661.125px] md:h-[661.125px] flex-shrink: 0;"
  xmlns="http://www.w3.org/2000/svg" width="1910" height="1910" viewBox="0 0 1910 1910" fill="none">
  ...
  <defs>
    <filter id="filter0_f_3050_2200" x="0" y="0" width="1909.12" height="1909.12" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
