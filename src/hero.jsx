...
function Hero() {
  ...
  useEffect(() => {
    ...
    const travelDistance = heroElement.offsetHeight;
    console.log(travelDistance);
    const moonHeight = moon.getBoundingClientRect().height/2;
    console.log(moonHeight);

gsap.to(moon, {
  y: -travelDistance + moonHeight, 
  duration: 3,
  ease: "power1.inOut",
});
    }
  ...
  return (
    <div className=" hero h-[90vh] md:h-[100vh] relative w-full text-center flex flex-col justify-center items-center">
  ...
  <svg 
  ref={moonRef}
  className="absolute -bottom-0 -z-10 w-[300px] h-[300px] md:w-[661.125px] md:h-[661.125px] flex-shrink: 0;"
